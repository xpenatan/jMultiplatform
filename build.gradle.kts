    ...
    publishing.publications.configureEach {
        if (this is MavenPublication) {
            pom {
                ...
                url.set("https://github.com/xpenatan/jMultiplatform")
                developers {
                    developer {
                        id.set("Xpe")
                        name.set("Natan")
                ...
                scm {
                    connection.set("scm:git:git://https://github.com/xpenatan/jMultiplatform.git")
                    developerConnection.set("scm:git:ssh://https://github.com/xpenatan/jMultiplatform.git")
                    url.set("http://https://github.com/xpenatan/jMultiplatform/tree/master")
                }
                licenses {
                    license {
